        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="Eliminars.html" class="nav-item nav-link ">Elimina  registros</a>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
                    <div id="success"></div>
                    <form  method= "Post" action="Update.php" ><!--name="sentMessage"id="contactForm" novalidate="novalidate"-->
                        ...
                        <div class="control-group">
                        <label>Correo</label>
                            <input value="<?php echo $reg['CliCorreo'];?>" type="email" class="form-control p-4" name="CliCorreo" id="CliCorreo" placeholder="Correo" ></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div>
                            <button  name="submit" type="submit" id="submit"class="btn btn-primary py-3 px-5">Actualizar Registro</button>
                        </div>
                    </form>
