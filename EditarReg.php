        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="EditarReg.php" class="nav-item nav-link active">Edita Registros</a>
                    <a href="Eliminars.html" class="nav-item nav-link active">Elimina un Registros</a>
                </div>
                <a href="?action=logout" class="btn btn-lg btn-primary px-3 d-none d-lg-block">Cerrar Sesion</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
            ...
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
                    ...
                    <form  method= "Post" action="Actualizars.php" ><!--name="sentMessage"id="contactForm" novalidate="novalidate"-->
                     ...
                     <div class="control-group">
                            <input type="text" class="form-control p-4" name="CliNombre" id="CliNombre" placeholder="Nombre"  />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control p-4" name="CliCorreo" id="CliCorreo" placeholder="Correo" ></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control p-4" name="CliTelefono" id="CliTelefono" placeholder="Telefono" ></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control p-4" name="CliDireccion" id="CliDireccion" placeholder="Direccion" ></p>
                        </div>
                        <div>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <p><i class="fa fa-envelope mr-2"></i>Said@hotmail.com</p>
                    ...
                    <div class="col-md-4 mb-5">
                        <h5 class="text-primary mb-4">Nuevas</h5>
                        <form action="">
                            <div class="form-group">
                                <input type="text" class="form-control border-0" placeholder="Nombre" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control border-0" placeholder="Correo" required="required" />
                            </div>
                            <div>
                                <button class="btn btn-lg btn-primary btn-block border-0" type="submit">Inicia hoy</button>
                            </div>
                        </form>
                    </div>
                </div>
