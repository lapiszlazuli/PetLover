        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="Acercade.php" class="nav-item nav-link active">Acerca de</a>
                    ...
                    <a href="MisCitas.php" class="nav-item nav-link">Lista de Citas</a>
                <?php endif; ?>
                    <?php if (htmlspecialchars($_SESSION['username'])=="admin"): ?>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <a href="Inscribirse.php" class="btn btn-lg btn-primary mt-3 px-4">Inscribite hoy</a>
            </div>
            <div class="col-lg-5">
                <div class="row px-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-2" href="Servicios.php"><i class="fa fa-angle-right mr-2"></i>Nuestros Servicios</a>
                            <a class="text-white mb-2" href="Inscribirse.php"><i class="fa fa-angle-right mr-2"></i>Nuestro Equipo</a>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="">
                            ...
                            <div>
                                <button class="btn btn-lg btn-primary btn-block border-0" type="submit">Registrate</button>
                            </div>
                        </form>
                    </div>
                </div>
